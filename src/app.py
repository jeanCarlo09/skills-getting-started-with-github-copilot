...
activities = {
    ...
    "Swimming Club": {
        "description": "Lap swimming and technique training at the community pool",
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and putting on school plays",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Add student
    # Idempotent signup: do not add duplicate emails
